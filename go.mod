...
replace (
	github.com/cosmos/cosmos-sdk => github.com/neobase-one/cosmos-sdk v0.45.6-fh-dev-1
	github.com/tendermint/tendermint => github.com/neobase-one/tendermint v0.34.20-fh-dev-1
)
