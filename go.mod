...
replace (
	github.com/cosmos/cosmos-sdk => github.com/neobase-one/cosmos-sdk v0.45.9-fh-dev-1
	github.com/tendermint/tendermint => github.com/neobase-one/tendermint v0.34.21-fh-dev-1
)
